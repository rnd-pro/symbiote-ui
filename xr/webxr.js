...
export const WEBXR_RENDERER = Object.freeze({
  ...
  capabilities: [
    ...
    'xr-spatial-window-assembly',
    'xr-spatial-window-sync-layouts',
    'xr-spatial-window-default-placement',
    'xr-spatial-window-session-adopt-release',
    'xr-spatial-window-resize-preview-commit-cancel',
    'xr-spatial-window-ray-chrome-routing',
    ...
    'xr-spatial-window-dirty-texture-gating',
    'xr-spatial-window-cascade-theme-projection',
    'xr-spatial-window-fallback-receipts',
