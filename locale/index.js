...
const EN_MESSAGES = Object.freeze({
  ...
  'chat.show.menu': 'Show menu',
  'chat.show.quickControls': 'Show quick controls',
  'chat.show.title': 'Show',
  'chat.show.openLayout': 'Open Show layout',
  'chat.show.returnToChat': 'Return Show to chat',
  'chat.show.progress': 'Show progress',
  'chat.show.restart': 'Restart presentation',
...
const RU_MESSAGES = Object.freeze({
  ...
  'chat.show.menu': 'Меню презентации',
  'chat.show.quickControls': 'Быстрые настройки презентации',
  'chat.show.title': 'Презентация',
  'chat.show.openLayout': 'Развернуть презентацию в панель',
  'chat.show.returnToChat': 'Вернуть презентацию в чат',
  'chat.show.progress': 'Ход презентации',
  'chat.show.restart': 'Начать презентацию сначала',
...
const ES_MESSAGES = Object.freeze({
  ...
  'chat.show.menu': 'Menú de la presentación',
  'chat.show.quickControls': 'Controles rápidos de la presentación',
  'chat.show.title': 'Presentación',
  'chat.show.openLayout': 'Abrir la presentación en un panel',
  'chat.show.returnToChat': 'Devolver la presentación al chat',
  'chat.show.progress': 'Progreso de la presentación',
  'chat.show.restart': 'Reiniciar la presentación',
  'chat.list.title': 'Chats',
  'chat.list.new': 'Nuevo',
