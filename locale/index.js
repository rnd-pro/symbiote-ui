...
const EN_MESSAGES = Object.freeze({
  ...
  'chat.composer.voiceCommandDefault': 'send',
  'chat.composer.voiceCommandToggleLabel': 'Send on "{command}"',
  'chat.composer.voiceCommandToggleOff': 'Send when saying "{command}"',
  'chat.composer.voiceCommandToggleOn': 'Auto-send is on. Say "{command}" to submit.',
...
const RU_MESSAGES = Object.freeze({
  ...
  'chat.composer.voiceCommandDefault': 'отправить',
  'chat.composer.voiceCommandToggleLabel': 'Отправить по команде «{command}»',
  'chat.composer.voiceCommandToggleOff': 'Отправить по команде «{command}»',
  'chat.composer.voiceCommandToggleOn': 'Автоотправка включена. Скажите «{command}», чтобы отправить.',
...
const ES_MESSAGES = Object.freeze({
  ...
  'chat.composer.voiceCommandDefault': 'enviar',
  'chat.composer.voiceCommandToggleLabel': 'Enviar con "{command}"',
  'chat.composer.voiceCommandToggleOff': 'Enviar al decir "{command}"',
  'chat.composer.voiceCommandToggleOn': 'Autoenvío activado. Di "{command}" para enviar.',
  'chat.list.title': 'Chats',
  'chat.list.new': 'Nuevo',
