...
const browserSmokeSegments = [
  ...
  'show-chat reuses pre-registered chat elements across independent browser bundles',
  'aligned runtime preserves paused branch checkpoint across real WAV native seek',
  'agent dock and compact Show player keep reference desktop/mobile geometry',
  'Show attention animates presenter frames and persistent marker ink in real browser pixels',
