...
`ShowAudioArbiter` grants one audible source at a time. Audible media preempts and pauses speech before it begins. `ShowMediaController` exposes three canonical modes:
