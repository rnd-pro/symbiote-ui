...
const CASCADE_TOKEN_TARGET_CLASSIFIERS = [
  { group: 'color', pattern: /^--sn-(theme-|hue-|lit-|sys-|bg|panel-bg|layout-bg|node-bg|surface|text|text-dim|cat-|type-|graph-type-|canvas-graph-|tab|tabs|button|pagination-|segmented-|selection-|slider-|progress-|status-light-|metric-|cell|chat-bg|chat-message|chat-user|chat-agent|composer-bg|composer-action|composer-send|syntax-|field-|tree-|kanban-|chart-|data-table|list-|card|banner|badge|source|ctx-|xr-)/ },
...
export function createCascadeTheme(options = {}) {
  ...
  let tokens = {
    ...
    '--sn-media-studio-timeline-height': '220px',
    '--sn-media-studio-timeline-header-width': '140px',
    '--sn-media-studio-ruler-height': '28px',
    '--sn-media-studio-track-height': '36px',
    ...
    '--sn-agent-dock-inline-size': '33%',
    '--sn-agent-dock-min-inline-size': '320px',
    '--sn-agent-dock-max-inline-size': '640px',
    '--sn-agent-dock-mobile-inline-size': '100%',
    '--sn-agent-show-player-max-block-size': 'min(360px, 44dvh)',
    '--sn-agent-show-player-inset': 'var(--sn-space-sm)',
    ...
    '--sn-pagination-btn-bg': 'var(--sn-sys-surface-raised)',
    '--sn-pagination-btn-border': softOutlineColor,
    '--sn-pagination-btn-color': 'var(--sn-sys-on-surface)',
    '--sn-pagination-btn-hover-bg': 'color-mix(in oklab, var(--sn-sys-accent) 10%, var(--sn-sys-surface-raised))',
    '--sn-pagination-btn-hover-color': 'var(--sn-sys-on-surface)',
    '--sn-pagination-btn-active-bg': 'var(--sn-sys-accent)',
    '--sn-pagination-btn-active-border': 'var(--sn-sys-accent)',
    '--sn-pagination-btn-active-color': 'var(--sn-sys-on-accent)',
    '--sn-segmented-bg': 'color-mix(in oklab, var(--sn-sys-on-surface) 5%, transparent)',
    '--sn-segmented-border': softOutlineColor,
    '--sn-segmented-hover-bg': 'color-mix(in oklab, var(--sn-sys-on-surface) 8%, transparent)',
    '--sn-segmented-selected-bg': 'var(--sn-sys-accent)',
    '--sn-segmented-selected-color': 'var(--sn-sys-on-accent)',
    '--sn-selection-bg': 'var(--sn-field-control-bg)',
    '--sn-selection-border': outlineColor,
    '--sn-selection-color': 'var(--sn-sys-on-surface)',
    '--sn-selection-hover-border': 'var(--sn-sys-accent)',
    '--sn-selection-checked-bg': 'var(--sn-sys-accent)',
    '--sn-selection-checked-border': 'var(--sn-sys-accent)',
    '--sn-selection-mark-color': 'var(--sn-sys-on-accent)',
    '--sn-selection-error-border': 'var(--sn-sys-danger)',
    '--sn-selection-error-color': 'var(--sn-sys-danger)',
    '--sn-slider-track-bg': softOutlineColor,
    '--sn-slider-active-bg': 'var(--sn-sys-accent)',
    '--sn-slider-thumb-bg': 'var(--sn-sys-on-accent)',
    '--sn-slider-thumb-border': 'var(--sn-sys-accent)',
    '--sn-progress-bg': softOutlineColor,
    '--sn-progress-fill': 'var(--sn-sys-accent)',
    '--sn-status-light-bg': 'var(--sn-sys-surface-raised)',
    '--sn-status-light-color': 'var(--sn-sys-on-surface)',
    '--sn-status-light-neutral': 'var(--sn-sys-on-surface-dim)',
    '--sn-status-light-info': 'var(--sn-sys-accent)',
    '--sn-status-light-success': 'var(--sn-sys-success)',
    '--sn-status-light-warning': 'var(--sn-sys-warning)',
    '--sn-status-light-error': 'var(--sn-sys-danger)',
    '--sn-metric-border': softOutlineColor,
    ...
    '--sn-kanban-card-fg': 'var(--sn-sys-on-surface)',
    '--sn-kanban-card-border': softOutlineColor,
    '--sn-kanban-card-hover-border': 'var(--sn-sys-accent)',
    '--sn-kanban-drop-border': 'var(--sn-sys-accent)',
    '--sn-operations-overview-widget-bg': 'var(--sn-sys-surface-overlay)',
    '--sn-operations-overview-widget-border': softOutlineColor,
    '--sn-operations-overview-widget-radius': 'var(--sn-card-radius)',
    '--sn-operations-overview-widget-padding': 'var(--sn-step-5)',
    '--sn-operations-overview-widget-shadow': state.elevation === 0 ? 'none' : 'var(--sn-shadow-sm, none)',
    '--sn-chart-bg': 'var(--sn-sys-surface-panel)',
    '--sn-chart-border': softOutlineColor,
    '--sn-chart-threshold-color': 'var(--sn-sys-danger)',
    ...
    '--sn-button-sm-font-size': typeToken(11),
    '--sn-button-lg-font-size': typeToken(14),
    '--sn-button-icon-font-size': typeToken(16),
    '--sn-pagination-font-size': typeToken(12),
    '--sn-segmented-font-size': typeToken(11),
    '--sn-selection-font-size': typeToken(12),
    '--sn-selection-hint-size': typeToken(11),
    '--sn-status-light-font-size': typeToken(12),
    '--sn-metric-label-size': typeToken(12),
    '--sn-metric-value-size': typeToken(12),
    ...
    '--sn-kanban-title-size': headingToken(13),
    '--sn-kanban-description-size': typeToken(11),
    '--sn-kanban-card-title-size': headingToken(13),
    '--sn-kanban-card-summary-size': typeToken(11),
    '--sn-kanban-card-ticker-size': typeToken(11),
    '--sn-chart-title-size': headingToken(14),
    '--sn-chart-legend-size': typeToken(11),
    '--sn-chart-threshold-size': typeToken(9),
    '--sn-chart-tooltip-size': typeToken(11),
    ...
    '--sn-kanban-card-icon-size': typeToken(16),
    '--sn-kanban-card-hero-icon-size': typeToken(32),
    '--sn-kanban-card-audit-icon-size': typeToken(40),
    '--sn-kanban-card-idle-icon-size': typeToken(40),
    '--sn-kanban-card-metric-size': headingToken(40),
    '--sn-kanban-card-padding-sm': densityToken(8),
    '--sn-kanban-card-padding-md': densityToken(12),
    '--sn-kanban-card-padding-lg': densityToken(12),
    '--sn-kanban-card-padding-xl': densityToken(12),
    '--sn-kanban-card-gap-sm': densityToken(8),
    '--sn-kanban-card-gap-md': densityToken(10),
    '--sn-kanban-card-gap-lg': densityToken(12),
    '--sn-kanban-card-gap-xl': densityToken(12),
    '--sn-kanban-card-progress-thickness': densityToken(4),
    ...
    '--sn-button-sm-min-height': densityToken(22),
    '--sn-button-sm-padding': `${densityToken(2)} ${densityToken(8)}`,
    '--sn-button-lg-min-height': densityToken(36),
    '--sn-button-lg-padding': `${densityToken(6)} ${densityToken(16)}`,
    '--sn-pagination-btn-size': densityToken(28),
    '--sn-pagination-gap': densityToken(4),
    '--sn-segmented-gap': densityToken(2),
    '--sn-segmented-padding': `${densityToken(4)} ${densityToken(12)}`,
    '--sn-segmented-item-min-height': densityToken(20),
    '--sn-selection-control-size': densityToken(16),
    '--sn-selection-radio-dot-size': densityToken(6),
    '--sn-selection-switch-width': densityToken(30),
    '--sn-selection-switch-height': densityToken(18),
    '--sn-selection-switch-thumb-size': densityToken(14),
    '--sn-selection-switch-padding': densityToken(2),
    '--sn-selection-gap': densityToken(8),
    '--sn-selection-content-gap': densityToken(2),
    '--sn-slider-track-height': densityToken(4),
    '--sn-slider-thumb-size': densityToken(16),
    '--sn-slider-wrapper-height': densityToken(28),
    '--sn-slider-margin': `${densityToken(8)} 0`,
    '--sn-progress-bar-height': densityToken(6),
    '--sn-progress-ring-size': densityToken(36),
    '--sn-progress-ring-stroke': densityToken(4),
    '--sn-status-light-size': densityToken(8),
    '--sn-status-light-gap': densityToken(6),
    '--sn-metric-gap': densityToken(12),
    '--sn-metric-padding': `${densityToken(5)} 0`,
    ...
    '--sn-kanban-column-width': `minmax(${densityToken(232)}, ${densityToken(286)})`,
    '--sn-kanban-column-min-height': densityToken(240),
    '--sn-kanban-header-min-height': densityToken(54),
    '--sn-kanban-header-padding': `${densityToken(8)} ${densityToken(10)}`,
    '--sn-kanban-gap': densityToken(10),
    '--sn-kanban-padding': `0 0 ${densityToken(4)}`,
    '--sn-kanban-card-list-padding': densityToken(8),
    '--sn-kanban-card-gap': densityToken(8),
    '--sn-kanban-card-padding': densityToken(8),
    '--sn-chart-padding': densityToken(16),
    '--sn-chart-header-gap': densityToken(12),
    '--sn-chart-header-item-gap': densityToken(8),
    '--sn-chart-legend-gap': densityToken(12),
    '--sn-chart-legend-item-gap': densityToken(6),
    '--sn-chart-legend-swatch-width': densityToken(12),
    '--sn-chart-legend-swatch-height': densityToken(8),
    '--sn-chart-height': densityToken(220),
    '--sn-chart-tooltip-padding': `${densityToken(6)} ${densityToken(10)}`,
    ...
    '--sn-tree-row-radius': radiusToken(4),
    '--sn-tree-badge-radius': radiusToken(8),
    '--sn-kanban-radius': radiusToken(8),
    '--sn-kanban-card-radius': radiusToken(7),
    '--sn-chart-radius': radiusToken(6),
    '--sn-chart-legend-swatch-radius': radiusToken(2),
    '--sn-chart-tooltip-radius': radiusToken(4),
    '--sn-pagination-btn-radius': radiusToken(6),
    '--sn-segmented-radius': radiusToken(6),
    '--sn-selection-radius': radiusToken(4),
    '--sn-progress-radius': radiusToken(3),
