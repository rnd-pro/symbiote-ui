...
const DEFAULT_PROVIDER_THEME_TOKENS = {
  ...
  '--sn-node-callout-border': 'color-mix(in oklab, var(--sn-node-selected) 28%, var(--sn-node-border))',
  ...
  '--sn-node-active-border': 'color-mix(in oklab, var(--sn-node-selected) 50%, transparent)',
  ...
  '--sn-success-bg': 'color-mix(in oklab, var(--sn-success-color) 18%, transparent)',
  '--sn-success-border': 'color-mix(in oklab, var(--sn-success-color) 32%, transparent)',
  '--sn-success-bg-hover': 'color-mix(in oklab, var(--sn-success-color) 28%, transparent)',
  '--sn-success-border-hover': 'color-mix(in oklab, var(--sn-success-color) 52%, transparent)',
  '--sn-danger-bg': 'color-mix(in oklab, var(--sn-danger-color) 18%, transparent)',
  '--sn-danger-border': 'color-mix(in oklab, var(--sn-danger-color) 32%, transparent)',
  ...
  '--sn-badge-neutral-border': 'var(--sn-node-border)',
  ...
  '--sn-diagnostic-error-bg': 'color-mix(in oklab, var(--sn-danger-color) 7%, transparent)',
  '--sn-diagnostic-error-border': 'color-mix(in oklab, var(--sn-danger-color) 55%, transparent)',
  '--sn-diagnostic-warning-bg': 'color-mix(in oklab, var(--sn-warning-color) 5%, transparent)',
  '--sn-diagnostic-warning-border': 'color-mix(in oklab, var(--sn-warning-color) 45%, transparent)',
  ...
  '--sn-loading-bar-shadow': '0 0 8px color-mix(in oklab, var(--sn-node-selected) 45%, transparent)',
