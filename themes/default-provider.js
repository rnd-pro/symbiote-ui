...
const DEFAULT_PROVIDER_THEME_TOKENS = {
  ...
  '--sn-tree-label-size': 'calc(12px * var(--sn-theme-type-scale))',
  '--sn-tree-label-weight': '500',
  '--sn-tree-muted-color': 'var(--sn-sys-on-surface-dim)',
  '--sn-tree-icon-size': 'calc(15px * var(--sn-theme-type-scale))',
  '--sn-tree-badge-radius': 'calc(8px * var(--sn-theme-radius-scale))',
  '--sn-tree-badge-bg': 'var(--sn-sys-accent-container)',
  '--sn-tree-badge-color': 'var(--sn-sys-on-surface-dim)',
  '--sn-tree-badge-size': 'calc(10px * var(--sn-theme-type-scale))',
  '--sn-tree-badge-max-width': 'calc(88px * var(--sn-theme-density))',
  '--sn-tree-kind-size': 'calc(10px * var(--sn-theme-type-scale))',
  '--sn-tree-kind-max-width': 'calc(120px * var(--sn-theme-density))',
  ...
  '--sn-kanban-column-width': 'minmax(calc(232px * var(--sn-theme-density)), calc(286px * var(--sn-theme-density)))',
  '--sn-kanban-column-min-height': 'calc(240px * var(--sn-theme-density))',
  '--sn-kanban-header-min-height': 'calc(54px * var(--sn-theme-density))',
  '--sn-kanban-header-padding': 'var(--sn-step-4) var(--sn-step-5)',
  '--sn-kanban-gap': 'var(--sn-step-5)',
  '--sn-kanban-padding': '0 0 var(--sn-step-2)',
  '--sn-kanban-card-list-padding': 'var(--sn-step-4)',
  '--sn-kanban-card-gap': 'var(--sn-step-4)',
  '--sn-kanban-title-size': 'calc(13px * var(--sn-theme-type-scale))',
  '--sn-kanban-description-size': 'calc(11px * var(--sn-theme-type-scale))',
  '--sn-kanban-card-title-size': 'calc(13px * var(--sn-theme-type-scale))',
  '--sn-kanban-card-summary-size': 'calc(11px * var(--sn-theme-type-scale))',
  '--sn-kanban-card-ticker-size': 'calc(11px * var(--sn-theme-type-scale))',
  '--sn-kanban-radius': 'calc(8px * var(--sn-theme-radius-scale))',
  '--sn-kanban-card-radius': 'calc(7px * var(--sn-theme-radius-scale))',
  '--sn-kanban-card-padding': 'var(--sn-step-4)',
  '--sn-operations-overview-widget-bg': 'var(--sn-sys-surface-overlay)',
  '--sn-operations-overview-widget-border': 'var(--sn-sys-outline-subtle)',
  '--sn-operations-overview-widget-radius': 'var(--sn-card-radius)',
  '--sn-operations-overview-widget-padding': 'var(--sn-step-5)',
  '--sn-operations-overview-widget-shadow': 'var(--sn-shadow-sm, none)',
  '--sn-chart-bg': 'var(--sn-sys-surface-panel)',
  '--sn-chart-border': 'var(--sn-sys-outline-subtle)',
  '--sn-chart-threshold-color': 'var(--sn-sys-danger)',
  '--sn-chart-radius': 'calc(6px * var(--sn-theme-radius-scale))',
  '--sn-chart-padding': 'calc(16px * var(--sn-theme-density))',
  '--sn-chart-header-gap': 'calc(12px * var(--sn-theme-density))',
  '--sn-chart-header-item-gap': 'calc(8px * var(--sn-theme-density))',
  '--sn-chart-title-size': 'calc(14px * var(--sn-theme-type-scale))',
  '--sn-chart-legend-gap': 'calc(12px * var(--sn-theme-density))',
  '--sn-chart-legend-size': 'calc(11px * var(--sn-theme-type-scale))',
  '--sn-chart-legend-item-gap': 'calc(6px * var(--sn-theme-density))',
  '--sn-chart-legend-swatch-width': 'calc(12px * var(--sn-theme-density))',
  '--sn-chart-legend-swatch-height': 'calc(8px * var(--sn-theme-density))',
  '--sn-chart-legend-swatch-radius': 'calc(2px * var(--sn-theme-radius-scale))',
  '--sn-chart-height': 'calc(220px * var(--sn-theme-density))',
  '--sn-chart-threshold-size': 'calc(9px * var(--sn-theme-type-scale))',
  '--sn-chart-tooltip-padding': 'calc(6px * var(--sn-theme-density)) calc(10px * var(--sn-theme-density))',
  '--sn-chart-tooltip-radius': 'calc(4px * var(--sn-theme-radius-scale))',
  '--sn-chart-tooltip-size': 'calc(11px * var(--sn-theme-type-scale))',
  ...
  '--sn-button-sm-min-height': 'calc(22px * var(--sn-theme-density))',
  '--sn-button-sm-padding': 'calc(2px * var(--sn-theme-density)) calc(8px * var(--sn-theme-density))',
  '--sn-button-sm-font-size': 'calc(11px * var(--sn-theme-type-scale))',
  '--sn-button-lg-min-height': 'calc(36px * var(--sn-theme-density))',
  '--sn-button-lg-padding': 'calc(6px * var(--sn-theme-density)) calc(16px * var(--sn-theme-density))',
  '--sn-button-lg-font-size': 'calc(14px * var(--sn-theme-type-scale))',
  '--sn-pagination-btn-bg': 'var(--sn-sys-surface-raised)',
  '--sn-pagination-btn-border': 'var(--sn-sys-outline-subtle)',
  ...
  '--sn-pagination-btn-size': 'calc(28px * var(--sn-theme-density))',
  '--sn-pagination-btn-radius': 'calc(6px * var(--sn-theme-radius-scale))',
  '--sn-pagination-gap': 'calc(4px * var(--sn-theme-density))',
  '--sn-pagination-font-size': 'calc(12px * var(--sn-theme-type-scale))',
  '--sn-pagination-disabled-opacity': '0.5',
  '--sn-pagination-focus-ring': 'var(--sn-effect-focus-ring)',
  '--sn-segmented-bg': 'color-mix(in oklab, var(--sn-sys-on-surface) 5%, transparent)',
  '--sn-segmented-border': 'var(--sn-sys-outline-subtle)',
  ...
  '--sn-segmented-selected-shadow': 'var(--sn-sys-shadow-raised)',
  '--sn-segmented-radius': 'calc(6px * var(--sn-theme-radius-scale))',
  '--sn-segmented-gap': 'calc(2px * var(--sn-theme-density))',
  '--sn-segmented-padding': 'calc(4px * var(--sn-theme-density)) calc(12px * var(--sn-theme-density))',
  '--sn-segmented-item-min-height': 'calc(20px * var(--sn-theme-density))',
  '--sn-segmented-font-size': 'calc(11px * var(--sn-theme-type-scale))',
  '--sn-segmented-font-weight': '500',
  '--sn-segmented-line-height': '1.35',
  '--sn-segmented-disabled-opacity': '0.5',
  '--sn-segmented-focus-ring': 'var(--sn-effect-focus-ring)',
  '--sn-selection-bg': 'var(--sn-field-control-bg)',
  '--sn-selection-border': 'var(--sn-field-control-border)',
  ...
  '--sn-selection-control-size': 'calc(16px * var(--sn-theme-density))',
  '--sn-selection-radio-dot-size': 'calc(6px * var(--sn-theme-density))',
  '--sn-selection-switch-width': 'calc(30px * var(--sn-theme-density))',
  '--sn-selection-switch-height': 'calc(18px * var(--sn-theme-density))',
  '--sn-selection-switch-thumb-size': 'calc(14px * var(--sn-theme-density))',
  '--sn-selection-switch-padding': 'calc(2px * var(--sn-theme-density))',
  '--sn-selection-gap': 'calc(8px * var(--sn-theme-density))',
  '--sn-selection-content-gap': 'calc(2px * var(--sn-theme-density))',
  '--sn-selection-radius': 'calc(4px * var(--sn-theme-radius-scale))',
  '--sn-selection-font-size': 'calc(12px * var(--sn-theme-type-scale))',
  '--sn-selection-hint-size': 'calc(11px * var(--sn-theme-type-scale))',
  '--sn-selection-disabled-opacity': '0.5',
  '--sn-selection-focus-ring': 'var(--sn-effect-focus-ring)',
  '--sn-slider-track-bg': 'var(--sn-sys-outline-subtle)',
  '--sn-slider-active-bg': 'var(--sn-sys-accent)',
  '--sn-slider-thumb-bg': 'var(--sn-sys-on-accent)',
  '--sn-slider-thumb-border': 'var(--sn-sys-accent)',
  '--sn-slider-thumb-shadow': 'var(--sn-sys-shadow-raised)',
  '--sn-slider-track-height': 'calc(4px * var(--sn-theme-density))',
  '--sn-slider-thumb-size': 'calc(16px * var(--sn-theme-density))',
  '--sn-slider-wrapper-height': 'calc(28px * var(--sn-theme-density))',
  '--sn-slider-margin': 'calc(8px * var(--sn-theme-density)) 0',
  '--sn-slider-disabled-opacity': '0.5',
  '--sn-slider-focus-ring': 'var(--sn-effect-focus-ring)',
  '--sn-progress-bg': 'var(--sn-sys-outline-subtle)',
  '--sn-progress-fill': 'var(--sn-sys-accent)',
  '--sn-progress-bar-height': 'calc(6px * var(--sn-theme-density))',
  '--sn-progress-radius': 'calc(3px * var(--sn-theme-radius-scale))',
  '--sn-progress-ring-size': 'calc(36px * var(--sn-theme-density))',
  '--sn-progress-ring-stroke': 'calc(4px * var(--sn-theme-density))',
  ...
  '--sn-status-light-size': 'calc(8px * var(--sn-theme-density))',
  '--sn-status-light-gap': 'calc(6px * var(--sn-theme-density))',
  '--sn-status-light-font-size': 'calc(12px * var(--sn-theme-type-scale))',
