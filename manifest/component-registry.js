...
const WEBMCP_TOOLS = {
  'chat-composer': [
    ...
    },
    {
      ...
      description: 'Request host-owned voice input, wake listening, response, command mode, or language selection through the composer voice control surface.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
        properties: {
  ...
  },
  {
    ...
    contract: {
      ...
      methods: [
        ...
        { name: 'setVoiceInputState', type: 'function', description: 'Sets mic button state: idle, recording, or processing.' },
      ...
      events: [
        ...
        { name: 'chat-composer-voice-input', description: 'Requests host-owned voice input capture.' },
        { name: 'chat-composer-wake-listen', description: 'Requests host-owned wake listening toggle.' },
        ...
        { name: 'chat-composer-voice-approve', description: 'Approves a recording preview.' },
        { name: 'chat-composer-voice-cancel', description: 'Cancels a recording preview.' },
        { name: 'chat-composer-voice-send', description: 'Requests sending a voice preview result.' },
