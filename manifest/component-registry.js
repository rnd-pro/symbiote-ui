...
export let COMPONENTS = [
  ...
  },
  {
    ...
    contract: {
      ...
      schemaVersion: 'component-descriptor-v2',
      dataSchema: 'schemas/runtime-ui-v1.json',
      capabilities: ['cascade-theme-quick-controls', 'copy-parameters', 'reset-defaults', 'open-full-editor', 'local-storage', 'global-shell-action'],
      attributes: [
      ...
      events: [
        { name: 'cascade-theme-change', description: 'Emits after quick theme parameters are applied.', detail: [{ name: 'state', type: 'object' }] },
