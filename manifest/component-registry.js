  ...
  'chat-workspace': [
    {
      ...
      description: 'Set host-owned chat workspace state for chats, active chat id, transcript messages, composer state, voice controls, live status, and background lifecycle without owning transport or persistence.',
      inputSchema: {
        type: 'object',
...
export let COMPONENTS = [
  ...
  },
  {
    ...
    category: 'chat',
    description: 'Reusable chat workspace shell that composes sidebar, transcript, composer, voice intents, footer controls, and animated background lifecycle.',
    contract: {
      status: 'draft',
      schemaVersion: 'component-descriptor-v2',
      dataSchema: 'schemas/runtime-ui-v1.json',
      ...
      properties: [
        ...
        { name: 'composer', type: 'object', description: 'Composer state including value, context chips, footer controls, sending state, voice controls, and voice preview.' },
      ...
      methods: [
        ...
        { name: 'setComposerState', type: 'function', description: 'Sets composer value, context chips, footer controls, disabled/sending state, voice controls, and voice preview.' },
  ...
  },
  {
    ...
    category: 'chat',
    description: 'Generic chat composer with input, voice controls, context chips, footer controls, and autocomplete host.',
    contract: {
      status: 'draft',
      schemaVersion: 'component-descriptor-v2',
      dataSchema: 'schemas/runtime-ui-v1.json',
