...
export let COMPONENTS = [
  ...
  },
  {
    ...
    category: 'layout',
    description: 'Global application shell menu that binds topbar context, layout group tabs, and workspace content.',
    agent: {
      semanticRole: 'global layout group navigation shell',
      usage: 'Use as the host shell around panel-layout when agents or users need to switch layout groups, open workspace tabs, and keep tab navigation attached to the global menu.',
      dataOwnership: 'host-owned layout group and tab model; component renders topbar context, project-tabs, action slot, and workspace slot',
    },
    contract: {
      status: 'draft',
      schemaVersion: 'component-descriptor-v2',
      ...
      ssr: {
        ...
        notes: 'Global shell menu renders meaningful light-DOM structure and hydrates project-tabs for interaction in the browser.',
      },
    },
  },
  {
