...
export let COMPONENTS = [
  ...
  },
  {
    ...
    contract: {
      ...
      schemaVersion: 'component-descriptor-v2',
      dataSchema: 'schemas/runtime-ui-v1.json',
      capabilities: ['layout-tree', 'split-panels', 'cross-layout-peer-collapse', 'panel-registry', 'panel-menu-actions', 'ui-invoked-panels', 'responsive-behavior', 'importance-auto-collapse', 'min-size-fit', 'scroll-fallback', 'mobile-stack', 'mobile-drawer', 'mobile-swipe-mode', 'multi-drawer-handles', 'swipe-island-control', 'local-storage'],
      attributes: [
