...
const WEBMCP_TOOLS = {
  ...
  'chat-composer': [
    ...
    },
    {
      ...
      description: 'Request host-owned voice input, wake listening, response, command mode, language selection, or preview actions through the composer voice control surface.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
        properties: {
    ...
    },
    {
      ...
      description: 'Document or request host-owned permission, recorder, and transcription intents for composer voice flows. The component emits intents only; browser permissions, MediaRecorder, speech recognition, and transcription providers remain host-owned.',
      inputSchema: {
        type: 'object',
        additionalProperties: false,
        properties: {
...
export let COMPONENTS = [
  ...
  },
  {
    ...
    contract: {
      ...
      methods: [
        { name: 'setWorkspaceState', type: 'function', description: 'Applies host-owned chat workspace state without owning transport, routes, persistence, recorder, or API calls.' },
        ...
        { name: 'setVoiceControls', type: 'function', description: 'Sets visible voice control state while leaving recorder and transcription ownership to the host.' },
        { name: 'setVoicePreview', type: 'function', description: 'Shows a host-owned voice transcription preview.' },
        { name: 'clearVoicePreview', type: 'function', description: 'Clears the host-owned voice transcription preview.' },
      ...
      events: [
        ...
        { name: 'chat-workspace-voice-intent', description: 'Routes host-owned voice permission, recorder, transcription, wake, response, command, language, and preview intents from the composed composer.' },
  ...
  },
  {
    ...
    contract: {
      ...
      methods: [
        ...
        { name: 'setVoiceControls', type: 'function', description: 'Sets visible voice buttons and their host-owned state.' },
        ...
        { name: 'getVoicePreviewText', type: 'function', description: 'Returns current voice preview text for host-owned transcription handling.' },
      ...
      events: [
        ...
        { name: 'chat-composer-voice-input', description: 'Requests host-owned voice input capture.', detail: [{ name: 'action', type: 'string' }, { name: 'currentState', type: 'string' }, { name: 'permission', type: 'string' }, { name: 'source', type: 'string' }] },
        { name: 'chat-composer-wake-listen', description: 'Requests host-owned wake listening toggle.', detail: [{ name: 'action', type: 'string' }, { name: 'currentState', type: 'string' }, { name: 'mode', type: 'string' }, { name: 'permission', type: 'string' }, { name: 'source', type: 'string' }] },
        { name: 'chat-composer-voice-response-toggle', description: 'Requests host-owned voice response toggle.' },
        { name: 'chat-composer-voice-command-toggle', description: 'Requests host-owned voice command mode toggle.' },
        { name: 'chat-composer-voice-language-change', description: 'Requests host-owned voice language mode change.', detail: [{ name: 'mode', type: 'string' }] },
        { name: 'chat-composer-permission-intent', description: 'Requests a host-owned permission flow such as microphone access; the component never calls browser permission APIs itself.', detail: [{ name: 'action', type: 'string' }, { name: 'permission', type: 'string' }, { name: 'reason', type: 'string' }, { name: 'source', type: 'string' }] },
        { name: 'chat-composer-recorder-intent', description: 'Requests host-owned recorder start, stop, or cancel behavior without owning MediaRecorder or capture policy.', detail: [{ name: 'action', type: 'string' }, { name: 'currentState', type: 'string' }, { name: 'mode', type: 'string' }, { name: 'permission', type: 'string' }, { name: 'source', type: 'string' }] },
        { name: 'chat-composer-transcription-intent', description: 'Requests host-owned transcription preview approve, cancel, or send behavior.', detail: [{ name: 'action', type: 'string' }, { name: 'source', type: 'string' }, { name: 'mode', type: 'string' }, { name: 'text', type: 'string' }] },
        { name: 'chat-composer-voice-approve', description: 'Approves a recording preview.', detail: [{ name: 'action', type: 'string' }, { name: 'source', type: 'string' }, { name: 'mode', type: 'string' }, { name: 'text', type: 'string' }] },
        { name: 'chat-composer-voice-cancel', description: 'Cancels a recording preview.', detail: [{ name: 'action', type: 'string' }, { name: 'source', type: 'string' }, { name: 'mode', type: 'string' }, { name: 'text', type: 'string' }] },
        { name: 'chat-composer-voice-send', description: 'Requests sending a voice preview result.', detail: [{ name: 'action', type: 'string' }, { name: 'source', type: 'string' }, { name: 'mode', type: 'string' }, { name: 'text', type: 'string' }] },
