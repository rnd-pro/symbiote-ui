...
export let COMPONENTS = [
  ...
  },
  {
    ...
    contract: {
      ...
      schemaVersion: 'component-descriptor-v1',
      dataSchema: 'schemas/runtime-ui-v1.json',
      capabilities: ['layout-tree', 'split-panels', 'panel-registry', 'panel-menu-actions', 'local-storage'],
      attributes: [
  ...
  },
  {
    ...
    contract: {
      ...
      schemaVersion: 'component-descriptor-v1',
      dataSchema: 'schemas/runtime-ui-v1.json',
      capabilities: ['layout-branch', 'layout-panel', 'resize', 'collapse', 'fullscreen', 'panel-menu', 'fold-down-panel-actions'],
      attributes: [
