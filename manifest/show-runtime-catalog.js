...
export const SHOW_RUNTIME_CONTRACT = Object.freeze({
  ...
  capabilities: Object.freeze([
    ...
    'muted-montage-media',
    'continuous-inline-media',
    'skippable-full-media',
    'custom-show-media-targets',
    'abortable-bounded-media-choreography',
  ...
  mediaPlayback: Object.freeze({
    ...
    targetHooks: Object.freeze(['captureShowMediaState', 'applyShowMediaPolicy', 'playShowMedia', 'pauseShowMedia', 'restoreShowMediaState']),
    nativeTarget: 'HTMLMediaElement',
    boundedCancellation: Object.freeze(['start', 'stop', 'replacement']),
